...
public class VCWorkerItemHandler implements WorkItemHandler{
	...
	private final Destination destination = new ActiveMQQueue("queue.vcoin.in");
	private final Destination reply = new ActiveMQQueue("queue.vcoin.out");
	...
	public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
		...
		try {
			...
			results.put("nextStep", CustomerWorkerItemHandler.HANDLER_ID);
			ksession.setGlobal("nextStep", CustomerWorkerItemHandler.HANDLER_ID);
			LOG.info("Response is of type = {}; nextStep = {} ", responseMessage.getMessageType(),CustomerWorkerItemHandler.HANDLER_ID);
